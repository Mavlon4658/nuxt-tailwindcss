...
const exerciseList = ref<Exercise[]>([
    {
        id: 1,
        title: 'Фраза для перевода в статусе заполенния',
        done: true,
        words: ['Ivan', 'love', 'to', 'play', 'football'],
        wordInp: ''
    },
    {
        id: 2,
        title: 'Переведенная фраза с показанным верным вариантом',
        done: false,
        words: ['Ivan', 'love', 'to', 'play', 'football'],
        wordInp: ''
    },
